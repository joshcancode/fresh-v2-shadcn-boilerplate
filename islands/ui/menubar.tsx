...
function MenubarMenu({ ...props }: preact.ComponentProps<typeof DropdownMenu>) {
  return <DropdownMenu data-slot="menubar-menu" {...props} />
}

function MenubarGroup({
  ...props
}: preact.ComponentProps<typeof DropdownMenuGroup>) {
  return <DropdownMenuGroup data-slot="menubar-group" {...props} />
}

function MenubarPortal({
  ...props
}: preact.ComponentProps<typeof DropdownMenuPortal>) {
...
function MenubarTrigger({
  className,
  ...props
}: preact.ComponentProps<typeof DropdownMenuTrigger>) {
  return (
    <DropdownMenuTrigger
...
function MenubarContent({
  ...
  sideOffset = 8,
  ...props
}: preact.ComponentProps<typeof DropdownMenuContent>) {
  return (
    <DropdownMenuContent
...
function MenubarItem({
  ...
  variant = "default",
  ...props
}: preact.ComponentProps<typeof DropdownMenuItem>) {
  return (
    <DropdownMenuItem
...
function MenubarRadioGroup({
  ...props
}: preact.ComponentProps<typeof DropdownMenuRadioGroup>) {
...
function MenubarLabel({
  ...
  inset,
  ...props
}: preact.ComponentProps<typeof DropdownMenuLabel> & {
  inset?: boolean
}) {
  return (
    <DropdownMenuLabel
...
function MenubarSeparator({
  className,
  ...props
}: preact.ComponentProps<typeof DropdownMenuSeparator>) {
  return (
    <DropdownMenuSeparator
...
function MenubarShortcut({
  className,
  ...props
}: preact.ComponentProps<typeof DropdownMenuShortcut>) {
  return (
    <DropdownMenuShortcut
...
function MenubarSub({
  ...props
}: preact.ComponentProps<typeof DropdownMenuSub>) {
...
function MenubarSubTrigger({
  ...
  inset,
  ...props
}: preact.ComponentProps<typeof DropdownMenuSubTrigger> & {
  inset?: boolean
}) {
  return (
    <DropdownMenuSubTrigger
...
function MenubarSubContent({
  className,
  ...props
}: preact.ComponentProps<typeof DropdownMenuSubContent>) {
  return (
    <DropdownMenuSubContent
